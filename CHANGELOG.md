...
- Stabilized documentation and versioning across all configuration files.
...
- Established the core versioning and documentation standards.

## [0.12.0] - 2026-05-21
- Optimized QuickJS-to-Native bridge performance.
- Implemented "Image" node type in the rendering pipeline.
- Conducted initial bridge benchmarks (1000 nodes in 2.45ms).
